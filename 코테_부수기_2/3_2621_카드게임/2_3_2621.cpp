...
int main() {
	...
	sort(card, card + 5);
	cout << card[0] << card[1] << card[2] << card[3] << card[4] << "card" << endl;
	...
	else if (((number[0] == number[1] && number[1] == number[2] && number[2]== number[3]) && (number[3] != number[4]) || (number[0] != number[1])  &&(number[1] == number[2] && number[2] == number[3] && number[3] == number[4]))) {
	...
	else if ((number[0] == number[1] && number[1] == number[2]) || (number[1] == number[2] && number[2] == number[3]) || (number[2] == number[3] && number[3] == number[4])) {
