...
if numbers[4] - numbers[3] == numbers[3] - numbers[2] == numbers[2]- numbers[1] == numbers[1] - numbers[0] == 1:
    ...
    elif dictn[numbers[1]] == 2 :#abbcc
        if dictn[numbers[0]] == 1 and dictn[numbers[3]] == 2:#abbcc
            scores.append(numbers[3]*10 + numbers[1] + 300)
        else: scores.append(numbers[1] + 200)
    elif dictn[numbers[3]] == 2 : #aabcc
        if dictn[numbers[0]] == 2 and dictn[numbers[2]] == 1 :
